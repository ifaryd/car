...
class Voiture(models.Model):
    ...
    photo_face         = models.ImageField(upload_to='images/', default="app/static/images/logo-light.png", null=True, blank=True)
    photo_longueur1    = models.ImageField(upload_to='images/', default="app/static/images/logo-light.png", null=True, blank=True)
    photo_longueur2    = models.ImageField(upload_to='images/', default="app/static/images/logo-light.png", null=True, blank=True)
    photo_arriere      = models.ImageField(upload_to='images/', default="app/static/images/logo-light.png", null=True, blank=True)
    photo_tableau      = models.ImageField(upload_to='images/', default="app/static/images/logo-light.png", null=True, blank=True)
    photo_option1      = models.ImageField(upload_to='images/', default="app/static/images/logo-light.png", null=True, blank=True)
    photo_option2      = models.ImageField(upload_to='images/', default="app/static/images/logo-light.png", null=True, blank=True)
    photo_option3      = models.ImageField(upload_to='images/', default="app/static/images/logo-light.png", null=True, blank=True)
    photo_moteur       = models.ImageField(upload_to='images/', default="app/static/images/logo-light.png", null=True, blank=True)
    photo_carte_grise  = models.ImageField(upload_to='images/', default="app/static/images/logo-light.png", null=True, blank=True)
    photo_assurance    = models.ImageField(upload_to='images/', default="app/static/images/logo-light.png", null=True, blank=True)
