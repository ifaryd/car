...
class Voiture(models.Model):
    ...
    photo_arriere      = models.ImageField(upload_to='images/', default="images/default.png", null=True, blank=True)
    photo_tableau      = models.ImageField(upload_to='images/', default="images/default.png", null=True, blank=True)
